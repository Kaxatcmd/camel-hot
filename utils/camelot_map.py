...
CAMELOT_MAP = {
    ...
    "D Major": "10B",
    "Eb Major": "5B",   # = D# Major
    "D# Major": "5B",   # = Eb Major (enharmonic — generated by chroma detector)
    "E Major": "12B",
    "F Major": "7B",
    "F# Major": "2B",   # = Gb Major
    "G Major": "9B",
    "Ab Major": "4B",   # = G# Major
    "G# Major": "4B",   # = Ab Major (enharmonic — generated by chroma detector)
    "A Major": "11B",
    "Bb Major": "6B",   # = A# Major
    "A# Major": "6B",   # = Bb Major (enharmonic — generated by chroma detector)
    "B Major": "1B",
